...
#define PITCH_MINIPC_ABSOLUTE_ANGLE_PID_KI 0.00f //4.00f
...
typedef struct
{
		//SZL 6-12-2022 添加 云台电机 mini PC 角度换 PID
    ...
    fp32 relative_angle;     //rad 相对于编码器中值offset_ecd的 relative angle
    fp32 relative_angle_set; //rad
    fp32 absolute_angle;     //rad INS算出来的姿态角 
    fp32 absolute_angle_set; //rad
    fp32 motor_gyro;         //rad/s 该电机 通过gyro得到的角速度
    fp32 motor_gyro_set;
    fp32 motor_speed;
